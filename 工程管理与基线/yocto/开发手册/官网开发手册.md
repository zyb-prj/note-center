...
有关图层以及如何创建图层的更多信息，请参阅《Yocto 项目开发任务手册》中的 "[使用 bitbake-layers 脚本创建常规图层](#3_8-使用-bitbake-layers-脚本创建普通图层)" 一节。
...
最简单的创建图层命令如下。该命令创建的图层名称与当前目录中的 "your_layer_name" 相对应：
